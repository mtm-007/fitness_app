...
def calculate_openai_cost(model, tokens):
    ...
    elif model_choice == 'gpt-4.1-nano':
        openai_cost = (tokens['prompt_tokens']* 0.0001 + tokens['completion_tokens'] * 0.0004) / 1000
    else: 
...
def rag(query, model="gpt-4o-mini",):
    ...
    openai_cost_evals = calculate_openai_cost(model, rel_token_stats)
    
    openai_cost = openai_cost_rag + openai_cost_evals
